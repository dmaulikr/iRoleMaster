 ...
 *
 * Each entry should hold either an Event or a Handout, though a player can create a 'void' entry as well. This should create an event on that specific time. This event will be called something like "<Character Name> event (<GameDate>)", and the GM can than later if desire create a proper event description and share it with other players.
 */
